...
import { SUCCESS, CREATED, BAD_REQUEST, DOES_NOT_EXIST, CONFLICT, SERVER_ERROR } from 'constants/responseCodes';
...
export const serverError = (res: Response, title: string, error?: ApiError) => res.status(SERVER_ERROR).send({ title, error });
